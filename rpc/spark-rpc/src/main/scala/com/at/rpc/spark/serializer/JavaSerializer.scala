...
package com.at.rpc.spark.serializer

import com.at.rpc.spark.RpcConf
import com.at.rpc.spark.util.{ByteBufferInputStream, ByteBufferOutputStream, Utils}
...
class JavaSerializer(conf: RpcConf) extends Serializer with Externalizable {
  ...
  override def newInstance(): SerializerInstance = {
    ...
    val streamFactory: SerializationStreamFactory = classLoader
      .loadClass(conf.get("spark.rpc.serialization.stream.factory", "com.at.rpc.spark.serializer.JavaSerializationStreamFactory"))
